            ...
            <div class="card form-card">
                <div class="form-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-1 text-light"><i class="feather-grid"></i> Create Category</h4>
                            <p class="mb-0 opacity-75 small">Add a new category to organize your products</p>
                        </div>
                ...
                <div class="form-content">
                    <form method="POST" action="{{ url('save/new/category') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <div class="radio-group">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="featured" id="featured_yes" value="1">
                                            <label class="form-check-label" for="featured_yes">
                                                Yes, Featured
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="featured" id="featured_no" value="0" checked>
                                ...
                                <div>
                                    <label class="form-label d-block mt-2">Show on Navbar</label>
                                    <div class="radio-group">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="show_on_navbar" id="navbar_yes" value="1" checked>
                                            <label class="form-check-label" for="navbar_yes">
                                                Yes, Show
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="show_on_navbar" id="navbar_no" value="0">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="page_title" class="form-control" 
                                    placeholder="Best Fashion Brands in Bangladesh">
                                @error('page_title')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control" rows="3" placeholder="Best Fashion Brands in Bangladesh"></textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="meta_description" id="meta_description" class="form-control" rows="3" placeholder="SEO optimized description (150-160 characters)" maxlength="160"></textarea>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="feather-check"></i> Save Category
                            </button>
                        </div>
                    </form>
                </div>
