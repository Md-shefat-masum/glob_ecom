        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ url('update/payment-type') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="paymenttype_id" value="{{ $data->id }}">
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group text-center pt-3">
                                    <a href="{{ url('view/all/customer') }}" style="width: 130px;"
