...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Rearrange Storage Types by Dragging them</h4>
                    ...
                    <form action="{{url('save/rearranged/storages')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <ol class="clearfix">
                            @php
                                $sl = 1;
                            ...
                            <li style="background: #{{rand(1000,9999)}};">
                                <input type="hidden" value="{{$storage->slug}}" name="slug[]">
                                {{$sl++}}) {{$storage->ram}}/{{$storage->rom}}
                            </li>
                            @endforeach
                        </ol>
