...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Rearrange Product Warrenties by Dragging them</h4>
                    ...
                    <form action="{{url('save/rearranged/warrenty')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <ol class="clearfix">
                            @php
                                $sl = 1;
                            ...
                            <li style="background: #{{rand(1000,9999)}};">
                                <input type="hidden" value="{{$warrenty->id}}" name="id[]">
                                {{$sl++}}) {{$warrenty->name}}
                            </li>
                            @endforeach
                        </ol>
